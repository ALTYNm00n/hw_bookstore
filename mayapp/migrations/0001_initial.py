# Generated by Django 3.2.7 on 2023-01-24 04:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book_category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='books', to='mayapp.bookcategory', verbose_name='категория книг')),
            ],
            options={
                'verbose_name': 'книга',
        ...
        migrations.AddField(
            model_name='author',
            name='book_category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='authors', to='mayapp.bookcategory', verbose_name='категория книг'),
        ),
        migrations.AddField(
            model_name='author',
            name='groups',
